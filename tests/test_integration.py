...
class TestIntegration(unittest.TestCase):
    ...
    def test_compile_all_examples(self):
        """Test that all example contracts compile successfully"""
        for dfy_file in self.examples_dir.glob('*.dfy'):
    ...
    def test_simple_token_structure(self):
        ...
        result = self.compiler.compile_file('examples/SimpleToken.dfy')
        self.assertTrue(result['success'])
    ...
    def test_counter_methods(self):
        ...
        result = self.compiler.compile_file('examples/Counter.dfy')
        self.assertTrue(result['success'])
    ...
    def test_erc20_token_features(self):
        ...
        result = self.compiler.compile_file('examples/ERC20Token.dfy')
        self.assertTrue(result['success'])
    ...
    def test_deterministic_compilation(self):
        ...
        source_file = 'examples/SimpleToken.dfy'
